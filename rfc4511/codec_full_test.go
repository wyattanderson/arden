...
func TestRFC4511CodecRoundTrips(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"search", &SearchRequest{BaseObject: LDAPDN("dc=example,dc=com"), Scope: ScopeWholeSubtree, DerefAliases: DerefNever, SizeLimit: 100, TimeLimitSeconds: 5, Filter: Present{Attribute: AttributeDescription("cn")}, Attributes: []AttributeSelector{AttributeSelector("cn")}}, &SearchRequest{}},
