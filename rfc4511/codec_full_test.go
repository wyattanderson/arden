...
func TestRFC4511CodecRoundTrips(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"search entry", SearchResultEntry{ObjectName: LDAPDN("cn=Jane"), Attributes: NewAttributes([]Attribute{attribute}...)}, &SearchResultEntry{}},
		{"search entry without values", SearchResultEntry{ObjectName: LDAPDN("cn=Jane"), Attributes: NewAttributes([]Attribute{emptyAttribute}...)}, &SearchResultEntry{}},
